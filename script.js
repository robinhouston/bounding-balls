...
const B2 = {name: "B2", x: 400, y: 420, r: 9};
const B3 = {name: "B3", x: 270, y: 200, r: 6};
const B4 = {name: "B4", x: 490, y: 140, r: 3};
const B5 = {name: "B5", x: 490, y: 260, r: 3};

const input_circles = [B1,B2,B3,B4,B5]; //[ d, D, c, b, a ];
